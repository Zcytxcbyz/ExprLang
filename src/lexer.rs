...
impl Lexer {
    ...
    pub fn next_token(&mut self) -> Token {
        loop {
            ...
            if let (Some('/'), Some('*')) = (self.peek_char(), self.input.get(self.pos + 1).copied()) {
        ...
        match self.peek_char() {
            ...
            Some(c) => {
                ...
                match (c, next) {
                    ...
                    ('=', Some('=')) => { self.pos += 2; Token::Equal }
                    ('!', Some('=')) => { self.pos += 2; Token::NotEqual }
